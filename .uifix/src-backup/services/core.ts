...
import { call, on as subscribe, transport, type UnlistenFn } from './transport';
...
export const workspaces = {
  ...
  remove: (id: string) => call<void>('workspace_remove', { id }),
};
...
export interface RunText {
  runId: string;
  sessionId: string;
  /** Incremental answer text. Reasoning content is never emitted here. */
  delta: string;
}
...
export interface CoreEvents {
  ...
  'sandbox://line': SandboxLine & { runId: string };
