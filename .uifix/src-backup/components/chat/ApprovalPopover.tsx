...
export const ApprovalPopover: React.FC<{ onClose: () => void }> = ({ onClose }) => {
  ...
  return (
    <div
      ...
      className="absolute bottom-full left-0 z-50 mb-2 w-80 max-w-[calc(100vw-2rem)] origin-bottom-left rounded-xl border nerve-border bg-[var(--popover)] p-1.5 text-[var(--popover-foreground)] shadow-[var(--shadow-lg)] animate-popover"
    >
