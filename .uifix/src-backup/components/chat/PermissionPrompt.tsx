...
export const PermissionPrompt: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="w-full max-w-lg overflow-hidden rounded-xl border nerve-border bg-[var(--popover)] text-[var(--popover-foreground)] shadow-[var(--shadow-lg)] animate-popover">
        {/* Header */}
